...
public class BlockEncoder implements ImageEncoder {
    ...
    public void render(@NonNull Appendable output) throws IOException {
        ...
        if (scaledImage == null) {
            ...
            int physicalWidth = targetWidth * fontSize.widthInPixels;
            int physicalHeight = targetHeight * fontSize.heightInPixels;
        ...
        int actualCols =
                Math.min(
                        (int) Math.ceil((double) scaledImage.getWidth() / fontSize.widthInPixels),
                        targetWidth);
        int actualRows =
                Math.min(
                        (int) Math.ceil((double) scaledImage.getHeight() / fontSize.heightInPixels),
                        targetHeight);
    ...
    private void renderBlocks(
        ...
        FontSize fontSize = FontSize.defaultFontSize();
        double pixelsPerSubPixelX = (double) fontSize.widthInPixels / cols;
        double pixelsPerSubPixelY = (double) fontSize.heightInPixels / rows;
