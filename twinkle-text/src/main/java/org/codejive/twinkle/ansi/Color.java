...
public interface Color {
     ...
     * pass the result to <code>Constants.style()</code> or use <code>toAnsiFg()</code>.
     *
     ...
     * represented by this instance. This is NOT the full CSI sequence, to get the full sequence
     * pass the result to <code>Constants.style()</code> or use <code>toAnsiBg()</code>.
     *
     * @return Embeddable ANSI escape code string
     */
    String toAnsiBgArgs();
    ...
    class BasicColor implements Color {
        ...
        public static final BasicColor BLACK =
                BasicColor.of("black", Constants.BLACK, Intensity.normal);
        public static final BasicColor RED = BasicColor.of("red", Constants.RED, Intensity.normal);
        public static final BasicColor GREEN =
                BasicColor.of("green", Constants.GREEN, Intensity.normal);
        public static final BasicColor YELLOW =
                BasicColor.of("yellow", Constants.YELLOW, Intensity.normal);
        public static final BasicColor BLUE =
                BasicColor.of("blue", Constants.BLUE, Intensity.normal);
        public static final BasicColor MAGENTA =
                BasicColor.of("magenta", Constants.MAGENTA, Intensity.normal);
        public static final BasicColor CYAN =
                BasicColor.of("cyan", Constants.CYAN, Intensity.normal);
        public static final BasicColor WHITE =
                BasicColor.of("white", Constants.WHITE, Intensity.normal);

        public static final BasicColor DARK_BLACK =
                BasicColor.of("black", Constants.BLACK, Intensity.dark);
        public static final BasicColor DARK_RED =
                BasicColor.of("red", Constants.RED, Intensity.dark);
        public static final BasicColor DARK_GREEN =
                BasicColor.of("green", Constants.GREEN, Intensity.dark);
        public static final BasicColor DARK_YELLOW =
                BasicColor.of("yellow", Constants.YELLOW, Intensity.dark);
        public static final BasicColor DARK_BLUE =
                BasicColor.of("blue", Constants.BLUE, Intensity.dark);
        public static final BasicColor DARK_MAGENTA =
                BasicColor.of("magenta", Constants.MAGENTA, Intensity.dark);
        public static final BasicColor DARK_CYAN =
                BasicColor.of("cyan", Constants.CYAN, Intensity.dark);
        public static final BasicColor DARK_WHITE =
                BasicColor.of("white", Constants.WHITE, Intensity.dark);

        public static final BasicColor BRIGHT_BLACK =
                BasicColor.of("black", Constants.BLACK, Intensity.bright);
        public static final BasicColor BRIGHT_RED =
                BasicColor.of("red", Constants.RED, Intensity.bright);
        public static final BasicColor BRIGHT_GREEN =
                BasicColor.of("green", Constants.GREEN, Intensity.bright);
        public static final BasicColor BRIGHT_YELLOW =
                BasicColor.of("yellow", Constants.YELLOW, Intensity.bright);
        public static final BasicColor BRIGHT_BLUE =
                BasicColor.of("blue", Constants.BLUE, Intensity.bright);
        public static final BasicColor BRIGHT_MAGENTA =
                BasicColor.of("magenta", Constants.MAGENTA, Intensity.bright);
        public static final BasicColor BRIGHT_CYAN =
                BasicColor.of("cyan", Constants.CYAN, Intensity.bright);
